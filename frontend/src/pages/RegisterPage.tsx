  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Register Card with enhanced effects */}
        <div className="card glass-light space-y-6">
          <div className="relative">
            <h2 className="text-2xl font-bold text-white mb-2">Create Account</h2>
            <p className="text-gray-400 text-sm">
              Sign up to get started with AI-powered loan risk prediction
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 relative">
            ...
            <div className="group">
              ...
              <div className="relative">
                <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-primary-400 transition-colors" size={20} />
                <input
                  type="text"
                  value={name}
